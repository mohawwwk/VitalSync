...
export const articles: Article[] = [
  // --- Neuroscience ---
  {
    ...
    content: `
      Burnout is not just "feeling tired." It is a physiological state characterized by the dysregulation of the HPA (Hypothalamic-Pituitary-Adrenal) axis. 
    ...
    youtubeLinks: [
      { title: "The Science of Burnout", url: "https://www.youtube.com/embed/G078YpAn3pA" }
    ],
    featured: true
  },
  {
    ...
    description: "Deep dive into synaptic pruning and long-term potentiation.",
    content: `
    ...
    youtubeLinks: [
      { title: "Neuroplasticity Explained", url: "https://www.youtube.com/embed/LNHBMFCzznE" }
    ],
    featured: false
  },
  {
    ...
    youtubeLinks: [
      { title: "Dopamine & Motivation", url: "https://www.youtube.com/embed/QmOF0crdyRU" }
    ],
    featured: false
  },
  {
    ...
    youtubeLinks: [
      { title: "Sleep & Memory", url: "https://www.youtube.com/embed/2Tz8m9HIsrM" }
    ],
    featured: false
  },
  // --- Ayurveda ---
  {
    ...
    youtubeLinks: [
      { title: "Understanding Vata Dosha", url: "https://www.youtube.com/embed/0_u66Yv_S6E" }
    ],
    featured: false
  },
  // --- Bio-Hacking ---
  {
    ...
    youtubeLinks: [
      { title: "Cold Exposure Benefits", url: "https://www.youtube.com/embed/tybOi4hjZFQ" }
    ],
    featured: false
  },
  // --- Quantum Energy ---
  {
    ...
    youtubeLinks: [
      { title: "Biophotons: Light of the Cell", url: "https://www.youtube.com/embed/R6R_O6qS76E" }
    ],
    featured: false
  }
];
